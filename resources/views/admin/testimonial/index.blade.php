                        ...
                        <div class="card">
                            <div class="card-header">
                                ...
                                <div class="card-tools">
                                    <a class="btn btn-green" href="{{url('admin/testimonials/create')}}" role="button">Create</a>
                                </div>
                            </div>
                                    ...
                                    <tr>
                                        ...
                                        @foreach($settings as $setting)
                                            <tr>
                                                ...
                                                <td class="text-center">{{$setting->author_name}}</td>
                                                <td class="text-center">
                                                    <a href="{{url($setting->image)}}" target="_blank">
                                                        <img src="{{url($setting->image)}}" alt="" style="width: 100px;">
                                                    </a>
                                                </td>
                                                <td class="text-center">{{$setting->heading}}</td>
                                                <td class="text-center">{{config('custom.status')[$setting->status]}}</td>
                                                <!-- <td class="text-center">
                                                    <a class="btn btn-primary btn-sm" href="{{url('admin/testimonials/'.$setting->id)}}">
                                                        <i class="fas fa-folder">
                                                        </i>
                                                        View
                                                    </a>
                                                    <a class="btn btn-info btn-sm" href="{{url('admin/testimonials/'.$setting->id.'/edit')}}">
                                                ...
                                                <td class="d-flex justify-content-center action-icons">
                                                    <a href="{{url('admin/testimonials/'.$setting->id)}}" class="btn btn-sm" data-bs-toggle="tooltip" data-bs-placement="top" title="view">
