                        ...
                        <div class="card">
                            <div class="card-header">
                                ...
                                <div class="card-tools">
                                    <a class="btn btn-green" href="{{url('admin/about_us/create')}}" role="button">Create</a>
                                </div>
                            </div>
                                ...
                                <table class="table table-bordered">
                                    ...
                                    @foreach($settings as $setting)
                                        <tr>
                                            ...
                                            <!-- <td class="text-center">
                                                <a class="btn btn-primary btn-sm" href="{{url('admin/about_us/'.$setting->id)}}">
                                                    <i class="fas fa-folder">
                                                    </i>
                                                    View
                                                </a>
                                                <a class="btn btn-info btn-sm" href="{{url('admin/about_us/'.$setting->id.'/edit')}}">
                                            ...
                                            <td class="d-flex justify-content-center action-icons">
                                                <a href="{{url('admin/about_us/'.$setting->id)}}" class="btn btn-sm" data-bs-toggle="tooltip" data-bs-placement="top" title="view">
                                                    <i class="fa-solid fa-eye"></i>
                                                </a>
                                                <a href="{{url('admin/about_us/'.$setting->id.'/edit')}}" class="btn btn-sm" data-bs-toggle="tooltip" data-bs-placement="top" title="edit">
