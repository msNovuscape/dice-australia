            ...
            <div class="container-fluid">
                ...
                <div class="card card-default">
                    <div class="card-header">
                        <h3 class="card-title">Create Ndis Pricing</h3>
                        <a href="{{url('admin/ndis_pricing')}}" class="back-button btn-green">List</a>
                    </div>
                    <div class="card-body">
                        @include('success.success')
                        @include('errors.error')
                        {!! Form::open(['url' => '/admin/ndis_pricing', 'class' => 'form-horizontal', 'method'=> 'POST','files' => true]) !!}
                        <div class="row">
                            <div class="col-md-6">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control"  id="inputPassword3" name="sub_title" value="{{old('sub_title')}}">
                                </div>
                            </div>
                            ...
                            <div class="col-md-12" >
                                <div class="form-group" >
                                    ...
                                    <textarea name="sub_description" class="summernote_class" rows="5" style="height: 658px;" >{{old('sub_description')}}</textarea>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label>Button</label>
                                    <input type="text" class="form-control"  id="inputPassword3" name="button" value="{{old('button')}}" placeholder = "Enter button name">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
