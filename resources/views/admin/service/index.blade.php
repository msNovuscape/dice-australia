                                    ...
                                    @foreach($services as $service)
                                        <tr>
                                            ...
                                            <td class="d-flex justify-content-center action-icons">
                                                ...
                                                <a href="{{url('admin/services/'.$service->id.'/delete')}}" class="btn btn-sm" data-bs-toggle="tooltip" data-bs-placement="top" title="delete" onclick="return confirm('Are you sure you want to delete?');">
